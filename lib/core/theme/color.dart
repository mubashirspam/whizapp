...
class AppColor {
  ...
  static const Color yellowBackgroundLight = Color(0xFFF3E1C6);
  static const Color yellowLight = Color(0xFFEEB14B);

  // text...
  static const Color textPrimeryLight = Color(0xFF181855);
  static const Color textSecondaryLight = Color(0xFFA3A6AB);
